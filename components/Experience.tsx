...
//         <div className="group relative grid gap-1 pb-1 sm:grid-cols-8 sm:gap-8 md:gap-4 transition-all duration-300 lg:hover:!opacity-100 lg:group-hover/list:opacity-50 -mx-4 p-4 rounded-lg lg:hover:bg-zinc-50/70">
//           <header
//             className="text-xs font-semibold uppercase tracking-wide text-zinc-400 sm:col-span-2 pt-1"
//             aria-label="2026 to present"
//           >
//             2025 — Present
//           </header>
...
//                 <span>
//                   Frontend Engineer · Gopius E-Learning Services
...
//               Lead frontend development on Gopius' Learning Management System,
//               building the core product experience from course delivery to
//               everyday user-facing features. Focus on writing modular,
//               accessible, and performant UI code while collaborating closely
//               with the product team to keep the interface consistent as the
//               platform scales.
//             </p>

//             <ul
//               className="mt-4 mb-4 flex flex-wrap gap-2"
//               aria-label="Technologies used at this position"
//             >
//               {[
//                 "JavaScript",
//                 "TypeScript",
...
//             <p className="mt-2 text-xs leading-relaxed text-zinc-500 font-normal">
//               Built and maintained frontend features for YSP's product, working
//               with the team to ship user-facing functionality and get hands-on
//               experience with real-world frontend development practices.
//             </p>
...
//               aria-label="Technologies used at this position"
//             >
//               {["JavaScript", "React.js","TypeScript", "Tailwind CSS"].map((tech) => (
//                 <li
//                   key={tech}
//                   className="flex items-center rounded-full bg-zinc-100 px-3 py-1 text-xs font-medium leading-5 text-zinc-800"
//                 >
...
//         <div className="group relative grid gap-1 pb-1 sm:grid-cols-8 sm:gap-8 md:gap-4 transition-all duration-300 lg:hover:!opacity-100 lg:group-hover/list:opacity-50 -mx-4 p-4 rounded-lg lg:hover:bg-zinc-50/70">
//           {/* Improved date size and contrast */}
//           <header
//             className="text-xs font-semibold uppercase tracking-wider text-zinc-500 sm:col-span-2 pt-1"
//             aria-label="2025 to present"
//           >
//             2025 — Present
//           </header>
...
//                 target="_blank"
//                 rel="noreferrer"
//                 className="inline-flex items-baseline font-semibold text-zinc-900 hover:text-zinc-950 focus-visible:text-zinc-950 group/link"
//               >
//                 <span className="absolute -inset-x-4 -inset-y-4 hidden rounded md:block"></span>
//                 <span>
//                   Frontend Engineer · Gopius E-Learning Services
...
//             {/* UPGRADED: text-base, high contrast text-zinc-600, and balanced top margin */}
